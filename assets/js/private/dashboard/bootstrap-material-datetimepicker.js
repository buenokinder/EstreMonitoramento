(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = { date: true, time: true, format: 'DD//MM/YYYY', minDate: null, maxDate: null, currentDate: null, lang: 'pt-br', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancelar', okText: 'OK', clearText: 'Limpar', nowText: 'Agora', switchOnClick: false };
   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<div class="dtp-close"><a href="javascript:void(0);"><i class="material-icons">limpar</i></</div>' +
                         '</header>' +
